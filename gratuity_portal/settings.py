...
# Azure AD Auth
SOCIAL_AUTH_AZUREAD_OAUTH2_PKCE_KEY = os.getenv("AZURE_CLIENT_ID")
SOCIAL_AUTH_AZUREAD_OAUTH2_PKCE_SECRET = os.getenv("AZURE_CLIENT_SECRET")
SOCIAL_AUTH_AZUREAD_OAUTH2_PKCE_TENANT_ID = os.getenv("AZURE_TENANT_ID")
SOCIAL_AUTH_LOGIN_REDIRECT_URL = '/'
SOCIAL_AUTH_LOGIN_ERROR_URL = '/'
SOCIAL_AUTH_AZUREAD_OAUTH2_PKCE_USE_PKCE = True
SOCIAL_AUTH_REDIRECT_IS_HTTPS = not DEBUG  # force HTTPS in production
...
SOCIAL_AUTH_AZUREAD_OAUTH2_PKCE_REDIRECT_URI = os.getenv("AZURE_REDIRECT_URI")
...
LOGGING = {
    ...
    'loggers': {
        'testimonials.azure_backend': {'handlers': ['console'], 'level': 'INFO'},
    },
}
